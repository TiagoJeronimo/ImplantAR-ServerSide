...
namespace ConstructiveSolidGeometry
{
    ...
    public class CSG
    {
        ...
        public CSG subtract(CSG csg)
        {
            ...
            //Debug.Log("polygon count in A is " + polygons.Count);
            //Debug.Log("polygon count in B is " + csg.polygons.Count);
            //Debug.Log("polygon count in Node a is " + a.polygons.Count);
            //Debug.Log("polygon count in Node b is " + b.polygons.Count);
